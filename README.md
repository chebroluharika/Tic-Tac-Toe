...
5. The objective is to make 15 points in a row, column or a diagonal. The player can use the opponent's numbers in the grid to make 15.
6. The game terminates when any one of the players makes 15.
